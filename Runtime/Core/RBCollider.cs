...
namespace RBPhys
{
    public abstract class RBCollider : RBVirtualComponent
    {
        ...
        [NonSerialized] public float cr_ki = .03f; //Õ“Ë‰ðÁˆ— IƒQƒCƒ“
        [NonSerialized] public float cr_kd = .005f; //Õ“Ë‰ðÁˆ— DƒQƒCƒ“
        ...
        public void FindParent()
        {
            ...
            if (parent != null && parent.VEnabled && parent.PhysComputer == PhysComputer) 
            {
