...
namespace RBPhys
{
    public abstract class RBCollider : MonoBehaviour
    {
        ...
        [NonSerialized] public float cr_kp = 0.75f; //Õ“Ë‰ðÁˆ— PƒQƒCƒ“
        [NonSerialized] public float cr_ki = 0.75f; //Õ“Ë‰ðÁˆ— IƒQƒCƒ“
        [NonSerialized] public float cr_kd = 0.75f; //Õ“Ë‰ðÁˆ— DƒQƒCƒ“

        [NonSerialized] public float restitution = 0.35f; //”½”­ŒW”
        [NonSerialized] public float friction = 0.75f; //–€ŽCŒW”
