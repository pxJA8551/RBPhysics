...
namespace RBPhys
{
    public static partial class RBDetailCollision
    {
        ...
        {
            public static async Task<(Vector3 p, Vector3 pA, Vector3 pB, DetailCollisionInfo info)> CalcDetailCollisionInfo(RBColliderOBB obb_a, RBColliderSphere sphere_b)
            {
