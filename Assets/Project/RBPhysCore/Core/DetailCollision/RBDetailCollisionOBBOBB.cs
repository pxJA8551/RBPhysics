                ...
                if (pSqrMag != -1)
                {
                    ...
                    else
                    {
                        ...
                        for (int i = 0; i < bPd * 2; i++)
                        {
                            if (bPd == 1)
                            {
                                verts[4 + i] = bDp + (fB1 + fB2) * (i % 2 == 0 ? 1 : -1);
                            }
                            else if (bPd == 2)
                            {
                        ...
                        if (aPd == 1)
                        {
                            ...
                            ReverseProjectLineToLine(ref te_begin, ref te_end, verts[4], verts[5]);
                            ReverseProjectLineToLine(ref te_begin, ref te_end, verts[5], verts[6]);
                        ...
                        else if (bPd == 1)
                        {
                            ...
                            ReverseProjectLineToLine(ref te_begin, ref te_end, verts[0], verts[1]);
                            ReverseProjectLineToLine(ref te_begin, ref te_end, verts[1], verts[2]);
