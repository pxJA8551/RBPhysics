...
namespace RBPhys
{
    public static partial class RBDetailCollision
    {
        ...
        {
            public static async Task<(Vector3 p, Vector3 pA, Vector3 pB, DetailCollisionInfo info)> CalcDetailCollisionInfo(RBColliderSphere sphere_a, RBColliderCapsule capsule_b)
            {
